              ...
              <div class="modal_content">
                <div class="content">
                  <div class="modal_info">
                    ...
                    <div class="line"></div>
                    <p class="content_text">Subscribe to recieve 10% off promocode plus exclusive offers and deals</p>
                    <div class="email_content">
                      <p class="label_email">Email-adress</p>
                      <input type="email" id="email" class="email" name="email" v-model.trim="email">
                      <div class="errors_block">
                        <p class="errors" :class="{ empty_field:email_error }">Please write down your EMAIL</p>
                        <p class="errors" :class="{ empty_field:email_invalid_error }">Please write down your correct EMAIL</p>
                        <p class="errors" :class="{ empty_field:duplicate_email_error }">You have already subscribed to the newsletter</p>
                        <p class="errors" :class="{ empty_field:check_error }">Subscribe is not possible without your consent.</p>
                        <p class="success" :class="{ success_field:success }">You have successfully subscribed to the newsletter.</p>
                      </div>
                    </div>
